...
def create_service():
    ...
    try:
        ...
        if template_type not in ["llamacpp", "ik_llamacpp", "vllm", "ds4", "tabbyapi", "ninfer"]:
            return jsonify({"error": 'template_type must be "llamacpp", "ik_llamacpp", "vllm", "ds4", "tabbyapi", or "ninfer"'}), 400
