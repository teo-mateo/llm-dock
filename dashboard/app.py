...
@app.route("/api/services/<service_name>/preview", methods=["GET"])
@require_auth
...
@app.route("/api/services/<service_name>/set-public-port", methods=["POST"])
@require_auth
...
@app.route("/api/global-api-key", methods=["GET"])
@require_auth
...
@app.route("/api/services/<service_name>/set-global-api-key", methods=["PUT"])
@require_auth
...
@app.route("/api/services/<service_name>/register-openwebui", methods=["POST"])
@require_auth
...
@app.route("/api/services/<service_name>/unregister-openwebui", methods=["POST"])
@require_auth
