...
LLM-Dock is a Docker Compose-based dashboard for managing local LLM inference services. It runs five inference engines — llama.cpp, its `ik_llama.cpp` fork, vLLM, ds4, and TabbyAPI (EXL3) — with automatic GPU detection, model discovery, and Open WebUI integration. See [Supported Engines](#supported-engines).
...
Five engines are first-class. "First-class" means all four of: a Jinja template
